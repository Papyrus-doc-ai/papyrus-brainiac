...
function call() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const question = yield generator.getQuestionForSuggestion(document, response[0]);
        ...
        new Promise(resolve => rl.question("Q: " + question + "\nA: ", ans => {
            ...
            const updated = yield generator.updateDocumentWithAnswer(document, suggestion, answer);
            console.log(updated);
        }));
    });
}
